...
pub use schema::{
    ...
    MAX_BAUD_RATE, MAX_FRONTEND_BRIDGE_RESPONSE_BYTES, MAX_GRAPH_BYTES, MAX_GRAPH_POINTS,
    MAX_GRAPH_SERIES, MAX_GRAPH_SERIES_NAME_LENGTH, MAX_PROTOCOL_TEMPLATES, MAX_READ_BYTES,
    MAX_SEND_BYTES, MAX_TARGET_LENGTH, MAX_TEMPLATE_DESCRIPTION_LENGTH, MAX_TEMPLATE_MARKER_BYTES,
    MAX_TEMPLATE_NAME_LENGTH, MAX_WAIT_BYTES, MAX_WAIT_TIMEOUT_MS,
};
pub use server::{
